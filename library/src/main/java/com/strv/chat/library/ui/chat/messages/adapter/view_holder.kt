...
abstract class  HeaderViewHolder(
    parent: ViewGroup,
    layoutId: Int
) : Binder<ChatItemView.Header>, RecyclerView.ViewHolder(LayoutInflater.from(parent.context).inflate(layoutId, parent, false))

abstract class MyMessageViewHolder(
    parent: ViewGroup,
    layoutId: Int
) : Binder<ChatItemView.MyTextMessage>, RecyclerView.ViewHolder(LayoutInflater.from(parent.context).inflate(layoutId, parent, false))

abstract class OtherMessageViewHolder(
    parent: ViewGroup,
    layoutId: Int
) : Binder<ChatItemView.OtherTextMessage>, RecyclerView.ViewHolder(LayoutInflater.from(parent.context).inflate(layoutId, parent, false))
