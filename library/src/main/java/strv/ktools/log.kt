...
private var showCodeLocationLine = true
...
// inline because it would mess-up the call stack when showing lineNumber of StackTraceElement
inline fun <T> T.log(): T = apply { logMe() }

inline fun <T> T.logD(): T = apply { logMeD() }
